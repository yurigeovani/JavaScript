...
const calcularMedia = array => ((array.reduce((a,b)=>a+b))/array.length).toFixed(2)
...
function recerberMelhorEstudante (obj) {
    ...
    return console.log({nome: melhorAluno, media: melhorMedia})
}
